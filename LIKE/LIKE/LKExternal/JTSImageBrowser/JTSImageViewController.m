...
- (void)setupImageAndDownloadIfNecessary:(JTSImageInfo *)imageInfo {
    if (imageInfo.image) {
        ...
        if ([LCUIImageCache.singleton hasCachedWithKey:imageInfo.imageURL.absoluteString]) {
            
            UIImage * image = [LCUIImageCache.singleton imageWithKey:imageInfo.imageURL.absoluteString];
            
            if (self.imageInfo.fromView) {
                ...
                [self.imageInfo.fromView.layer addAnimation:animation forKey:@"transition"];
                self.imageInfo.fromView.image = image;
            }
...
//    [self.imageView addGestureRecognizer:longPress];
    ...
    self.progressView.tintColor = LKColor.color;
