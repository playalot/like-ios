...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        titleLabel.font = LK_FONT(FONT_SIZE);
...
+(RKDropdownAlert *)title:(NSString*)title backgroundColor:(UIColor*)backgroundColor textColor:(UIColor*)textColor time:(NSInteger)seconds
{
    RKDropdownAlert * alertView = [self alertView];
    
    [alertView title:title message:nil backgroundColor:backgroundColor textColor:textColor time:seconds];
