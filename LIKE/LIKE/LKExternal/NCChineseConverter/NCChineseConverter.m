...
@interface NCChineseConverter ()

LC_PROPERTY(strong) NSDictionary * dict;
LC_PROPERTY(strong) NSDictionary * dictFiles;
      ...
      for (NSString *line in arrLines) {
        ...
        NSArray * arrWords = [line componentsSeparatedByString:@"\t"];
          ...
          if (arrWords.count == 2){
            ...
            NSMutableDictionary * dicter = _dict[dictType];
            
            [dicter setObject:arrWords[1] forKey:arrWords[0]];
      }
    }
    }
  }
